...
public class BasicProfession {
    /**
     * The unique code ID of the profession in the <a href="https://developer.textkernel.com/tx-platform/v10/data-enrichment/overview/#professions-taxonomies">Professions Taxonomy</a>.
     */
