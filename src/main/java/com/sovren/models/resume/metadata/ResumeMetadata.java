...
public class ResumeMetadata extends ParsedDocumentMetadata {
    ...
    /**
     * This is an advanced level feature. Please ignore the data in the Resume Quality output unless/until you have discussed its proper use with Sovren, and been approved to use it.</span><br/><br/>
