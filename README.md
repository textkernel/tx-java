...
```
implementation "com.sovren:sovren-java:0.1.15-beta
```
...
- The Sovren JAR from https://repo1.maven.org/maven2/com/sovren/sovren-java/0.1.15-beta/sovren-java-0.1.15-beta.jar
